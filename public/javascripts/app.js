  ...
  var vue = new Vue({
    ...
    methods: {
      ...
      randomFace: function (action) {
        this.eyeIndex = Math.floor(Math.random() * (this.eyeCount));
        this.decoIndex = Math.floor(Math.random() * (this.mouthCount));
        this.mouthIndex = Math.floor(Math.random() * (this.decoCount));
        this.bgIndex = Math.floor(Math.random() * (this.bgCount));
      },
      //切換眼睛
